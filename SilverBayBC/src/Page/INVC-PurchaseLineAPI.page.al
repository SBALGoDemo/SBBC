...
page 50020 "INVC Purchase Line API"
{
    PageType = API;

    APIVersion = 'v2.0';
    APIPublisher = 'innovia';
    APIGroup = 'customapi';

    EntityCaption = 'InnoviaPurchaseInvoiceLine';
    EntitySetCaption = 'InnoviaPurchaseInvoiceLines';
    EntityName = 'innoviaPurchaseInvoiceLine';
    EntitySetName = 'innoviaPurchaseInvoiceLines';
