// https://odydev.visualstudio.com/ThePlan/_workitems/edit/2045 - Changes to AR Agings Report
// Copied from default report 106, the modified lines are marked with a comment
report 50080 "OBF-Customer Detailed Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src\ReportLayouts\OBF-CustomerDetailedAging.rdlc';
    AdditionalSearchTerms = 'customer balance,payment due';
    ApplicationArea = Basic, Suite;
    Caption = 'SB Customer Detailed Aging';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            // https://odydev.visualstudio.com/ThePlan/_workitems/edit/2045 - Changes to AR Agings Report
            column(Cust_Ledger_Entry_Your_Reference_Caption; Cust_Ledger_Entry_Your_Reference_CaptionLbl)
            {
            }
            column(Cust_Ledger_Entry_External_Document_No_Caption; Cust_Ledger_Entry_External_Document_No_CaptionLbl)
            {
            }
            column(Cust_Ledger_Entry_Description_First_Line_Caption; Cust_Ledger_Entry_Description_First_Line_CaptionLbl)
            {
            }
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    DataItemTableView = sorting("Posting Date", "Currency Code");
                    ...
                    // https://odydev.visualstudio.com/ThePlan/_workitems/edit/2045 - Changes to AR Agings Report
                    column(Cust_Ledger_Entry_Your_Reference_; "Your Reference")
                    {
                    }
                    column(Cust_Ledger_Entry_External_Document_No_; "External Document No.")
                    {
                    }
                    column(Cust_Ledger_Entry_Description_First_Line_; FirstSalesInvoiceLineDescription)
                    {
                    }
                    ...
                    begin
                        ...
                        if ("Document Type" <> "Document Type"::Payment) and ("Document Type" <> "Document Type"::"Credit Memo") then begin
    ...
    var
        ...
        // https://odydev.visualstudio.com/ThePlan/_workitems/edit/2045 - Changes to AR Agings Report
        Cust_Ledger_Entry_Your_Reference_CaptionLbl: Label 'Invoice No. to Print';
        Cust_Ledger_Entry_External_Document_No_CaptionLbl: Label 'Customer PO';
        Cust_Ledger_Entry_Description_First_Line_CaptionLbl: Label 'First Line Description';
