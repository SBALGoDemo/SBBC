...
// This is a copy of Report 1306 - Standard Sales - Invoice

report 50000 "OBF-Standard Sales - Invoice"
{
    ...
    begin
        ...
        if LineFeeNoteOnReportHist.FindSet() then
            ...
            LineFeeNoteOnReportHist.SetRange("Language Code", CU_Language.GetUserLanguageCode());
            if LineFeeNoteOnReportHist.FindSet() then
                repeat
                    TempLineFeeNoteOnReportHist.Init();
                    TempLineFeeNoteOnReportHist.Copy(LineFeeNoteOnReportHist);
