...
query 50002 "OBF-Sales Credit Memo"
{
    QueryType = API;
    ...
    APIGroup = 'customapi';
    EntityName = 'OBFSalesCreditMemo';
    EntitySetName = 'OBFSalesCreditMemo';
    EntityCaption = 'OBFSalesCreditMemo';
    EntitySetCaption = 'OBFSalesCreditMemo';
